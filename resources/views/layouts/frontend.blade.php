...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Accords Book provides accurate, reliable, and compliance-ready bookkeeping and accounting solutions for businesses of all sizes. Streamline your finances, payroll, and tax management with our expert team.">
...
<footer class="bg-mainTextColor text-white/60">
  <div class="container grid grid-cols-12 py-10 gap-6">
    ...
    <div class="col-span-12 sm:col-span-6 lg:col-span-4 flex flex-col gap-5">
      <a href="/">
          <img src="/frontend/my-img/footer-logo.png" alt="accords logo"  style="width:155px; height:90px;"/>
        </a>
  ...
  <div class="border-t border-white/10 mt-6">
    <div class="container py-5 flex justify-between items-center max-md:flex-col gap-4">
      <p class="text-center">
        Accords Book © 2026. All Rights Reserved.
      </p>
