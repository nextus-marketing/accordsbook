...
@section('title') Accords Book | Professional Bookkeeping & Accounting Services @endsection
@section('content')
    ...
    <section class="bg-repeat stp-30 hero_bg_gradient overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
           Welcome to Accords Bookkkkkkkkkk
</h1>
          <div class="display-2">
          Reliable  
          
            <div class="text-s3 inline-flex">Bookkeeping & Accounting Services</div>
            <br />
          for Growing Businesses
          </div>
          <p class="max-w-[550px]">
           Accords Book provides professional bookkeeping and accounting solutions designed to help businesses stay financially organized, compliant, and growth-ready.
          </p>
...
>
        ...
        <div class="grid grid-cols-12 stp-15 max-lg:gap-6">
          ...
          >
            ...
            <p class="text-bodyText">
             At <b>Accords Book</b>, we deliver accurate, transparent, and compliance-focused bookkeeping and accounting services tailored to your business needs. Our mission is to keep your financial records organized, up-to-date, and audit-ready—so you can make confident business decisions and focus on growth.
            </p>
  ...
  <div class="container">
    ...
    <div class="flex justify-between items-end gap-6 max-lg:flex-col max-lg:items-start">
        ...
        At Accords Book, we provide end-to-end bookkeeping and accounting solutions designed to keep your financial records accurate, your compliance on track, and your business running efficiently. Our services are reliable, scalable, and tailored to meet your unique business requirements.
        </p>
      </div>
    <!-- Services Grid -->
    <div class="grid grid-cols-12 gap-6 stp-15">
      ...
      <div class="col-span-12 sm:col-span-6 lg:col-span-4">
        <div
          ...
          <p class="text-mainTextColor/70 leading-relaxed max-w-[300px]">
           At Accords Book, we deliver clean, organized, and up-to-date bookkeeping services for businesses of all sizes. From bank reconciliations to detailed financial reporting, we ensure your books remain accurate, transparent, and audit-ready at all times.
          </p>
        </div>
      </div>
      ...
      <div class="col-span-12 sm:col-span-6 lg:col-span-4">
        <div
          ...
          <p class="text-mainTextColor/70 leading-relaxed max-w-[300px]">
          Accords Book offers timely, accurate, and fully compliant payroll services. We manage salary calculations, deductions, payslip generation, and statutory filings—allowing you to focus on your team while we handle the numbers.
          </p>
        </div>
      </div>
      ...
      <div class="col-span-12 sm:col-span-6 lg:col-span-4">
        <div
          ...
          <p class="text-mainTextColor/70 leading-relaxed max-w-[300px]">
          Accords Book is your trusted partner for professional tax preparation, filing, and accounting support. Our experts help you stay compliant, minimize financial risks, and optimize tax efficiency with practical, expert-led guidance.
          </p>
        </div>
      </div>
      ...
      <div class="col-span-12 sm:col-span-6 lg:col-span-4">
        <div
          ...
          <p class="text-mainTextColor/70 leading-relaxed max-w-[300px]">
          Our CFO Advisory services provide strategic financial leadership without the cost of a full-time CFO. From budgeting and forecasting to cash flow planning and performance analysis, we help you make informed, growth-driven decisions.
          </p>
        </div>
      </div>
      ...
      <div class="col-span-12 sm:col-span-6 lg:col-span-4">
        <div
          ...
          <p class="text-mainTextColor/70 leading-relaxed max-w-[300px]">
           With strong industry expertise, Accords Book offers smooth and hassle-free business incorporation services. We assist with documentation, registrations, and regulatory compliance to help you launch your business the right way.
          </p>
        </div>
      </div>
      ...
      <div class="col-span-12 sm:col-span-6 lg:col-span-4">
        <div
          ...
          <p class="text-mainTextColor/70 leading-relaxed max-w-[300px]">
           Our experienced tax professionals provide reliable sales tax consulting, filing assistance, and compliance management. Accords Book ensures your sales tax obligations are handled accurately—keeping your business penalty-free and fully compliant.
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <p class="pb-8 wow animate__animated animate__fadeInUp">
           Say goodbye to time consuming paperwork and financial stress. Accords Book handles your bookkeeping, accounting, payroll, and tax compliance—so you can focus on running and growing your business with confidence.
          </p>
...
<section class="stp-30 sbp-30 relative sponsors">
    ...
    <div class="container">
      <div class="flex justify-between items-end gap-6 max-lg:flex-col max-lg:items-start">
        ...
        <p class="text-bodyText max-w-[500px]">
          Our clients trust Accords Book for precise bookkeeping, smooth payroll, and reliable financial guidance that supports their growth.
        </p>
      </div>
    </div>
    <div class="pt-6">
      <div class="swiper testimonial-carousel2">
        <div class="swiper-wrapper !flex !justify-center !items-center">
          ...
          <div class="swiper-slide">
            <div class="border border-strokeColor p-12 flex flex-col justify-center items-center hover:bg-s2 hover:border-mainTextColor duration-700">
              <p class="text-bodyText text-center">
                "Accords Book transformed our accounting process. Everything is organized, clear, and audit-ready, giving us peace of mind."
              </p>
              <div class="flex gap-3 pt-3">
                <p class="text-lg font-medium">Amelia R.</p>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="border border-strokeColor p-12 flex flex-col justify-center items-center hover:bg-s2 hover:border-mainTextColor duration-700">
              <p class="text-bodyText text-center">
                "Thanks to Accords Book, payroll and tax compliance are no longer stressful. Their team is reliable and highly professional."
              </p>
              <div class="flex gap-3 pt-3">
                <p class="text-lg font-medium">Ethan L.</p>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="border border-strokeColor p-12 flex flex-col justify-center items-center hover:bg-s2 hover:border-mainTextColor duration-700">
              <p class="text-bodyText text-center">
                "They made bookkeeping simple and accurate. I finally have control over my business finances without the headache."
              </p>
              <div class="flex gap-3 pt-3">
                <p class="text-lg font-medium">Harper M.</p>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="border border-strokeColor p-12 flex flex-col justify-center items-center hover:bg-s2 hover:border-mainTextColor duration-700">
              <p class="text-bodyText text-center">
                "Working with Accords Book is a game-changer. Tax season is easy, and I feel confident about my financial records."
              </p>
              <div class="flex gap-3 pt-3">
                <p class="text-lg font-medium">Lucas P.</p>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="border border-strokeColor p-12 flex flex-col justify-center items-center hover:bg-s2 hover:border-mainTextColor duration-700">
              <p class="text-bodyText text-center">
                "Their team is thorough, professional, and extremely responsive. I trust them completely with my business accounting."
              </p>
              <div class="flex gap-3 pt-3">
                <p class="text-lg font-medium">Mia S.</p>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="border border-strokeColor p-12 flex flex-col justify-center items-center hover:bg-s2 hover:border-mainTextColor duration-700">
              <p class="text-bodyText text-center">
                "Accords Book handles all our bookkeeping and compliance tasks seamlessly. It’s such a relief to have a dependable partner."
              </p>
              <div class="flex gap-3 pt-3">
                <p class="text-lg font-medium">Noah W.</p>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="border border-strokeColor p-12 flex flex-col justify-center items-center hover:bg-s2 hover:border-mainTextColor duration-700">
              <p class="text-bodyText text-center">
                "Professional, accurate, and easy to work with. They manage our books better than I ever could."
              </p>
              <div class="flex gap-3 pt-3">
                <p class="text-lg font-medium">Sophia K.</p>
              </div>
            </div>
          </div>
